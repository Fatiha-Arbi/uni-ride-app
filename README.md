# UniRide – University Ride Sharing Application
...
- Ability to offer rides with route and timing details  
- Browse and view available rides  
...
2. User is directed to the ride feed  
3. User can:
